...
/*---------LEVEL FOUR FUNCTIONS START HERE------------*/
//isolate first box in LEVEL FOUR
function levelFourGridBox1(j) {
  let box1 = 13;
  let across = 2;
  let nextLine = 12;
  if (
